...
description: >
  ...
  "NPU power-of-2 scale", any Python traceback mentioning quark.onnx / onnxruntime / onnx, or when
  the user pastes an error message related to Quark ONNX workflows.
layer: l1-atomic
primary_artifact: validation_report.md
source_knowledge:
  - quark/onnx/quantization/quantize.py
  - quark/onnx/quantization/api.py
  - quark/onnx/quantization/input_check.py
  - quark/onnx/calibration/calibrators.py
  - quark/onnx/operators/custom_ops/build_custom_ops.py
  - quark/onnx/quantizers/registry.py
