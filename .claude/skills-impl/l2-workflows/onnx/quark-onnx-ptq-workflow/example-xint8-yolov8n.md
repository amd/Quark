...
End-to-end walkthrough of `quark-onnx-ptq-workflow` for an XINT8 PTQ run on the YOLOv8n object-detection model, targeting AMD NPU CNN (Ryzen AI) deployment. Calibration source: COCO `val2017`.
