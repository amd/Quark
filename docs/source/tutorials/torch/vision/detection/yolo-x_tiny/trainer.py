...
class Trainer:
    ...
    def ptq(self):
        ...
        graph_model = export_for_training(self.model.base_model, (dummy_input,)).module()
        ...
        quant_config = QConfig(global_quant_config=quant_config_1, quant_mode=QuantizationMode.fx_graph_mode)
    ...
    def qat(self):
        ...
        for epoch in range(self.start_epoch, self.max_epoch):
            self.epoch = epoch
            #  ------ before training
            logging.info(f"---> start train epoch{epoch + 1}")
