...
.. code:: sh
    ...
    %%sh
    SNAPSHOT=$(ls "$HF_HOME/hub/models--mistralai--Mistral-7B-v0.1/snapshots" | head -n 1)
    MODEL_PATH="$HF_HOME/hub/models--mistralai--Mistral-7B-v0.1/snapshots/$SNAPSHOT"
...
.. code:: ipython3
    ...
    !python3 quantize_quark.py --model_dir $MODEL_PATH --output_dir output_dir --quant_scheme int4_wo_128 --num_calib_data 128 --quant_algo awq --dataset pileval_for_awq_benchmark --seq_len 512 --model_export hf_format
