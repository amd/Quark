...
model for image classification tasks. Quantization reduces model size
and computation cost by converting high-precision floating-point
parameters into lower-bit representations, enabling faster inference and
lower memory usage.
...
.. code:: ipython3
    ...
    benchmarks = {"image_classification": {"acc1": 73.562, "acc5": 91.42}}
