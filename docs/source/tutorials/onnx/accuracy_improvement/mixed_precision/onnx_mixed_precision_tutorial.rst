...
.. code:: ipython3
    ...
    def getAccuracy_top1(preds: torch.Tensor | list, targets: torch.Tensor | list) -> float:
...
.. code:: ipython3
    ...
    top1, top5 = evaluate(mixed_precision_eval_config)
...
.. code:: ipython3
    ...
    model_name = "mixed_precision"
    
    benchmarks = {"mixed_precision": {"acc1": 75.216, "acc5": 92.768}}
            ...
            "data": [
                {
                    "experiment": {
                        ...
                        "settings": {
                            "quantization_scheme": "S16S16_MIXED_S8S8",
                            "quantization_algorithm": "Mixed Precision",
                        },
                    },
                    "metrics": [
                        {
