...
output_tensor = np.array([[
    0.13596348, 0.7069947 , -0.745268  , -0.8128995 , 0.25301066, 0.43890983, 0.10404871, 0.88007313, -0.11417447, -0.7310455
]]).astype(np.float32)
output_tensor_gptq = np.array([[
    0.14073174, 0.72223854, -0.7341187, -0.8268701, 0.22473133, 0.44346523, 0.1087392, 0.8950456, -0.13907433, -0.74229425
]]).astype(np.float32)
output_tensor_hqq = np.array([[0.13278924, 0.7027687, -0.7434849, -0.8260411, 0.26645112, 0.4434718, 0.10804553, 0.89408153, -0.1228957, -0.7243466]]).astype(np.float32)
