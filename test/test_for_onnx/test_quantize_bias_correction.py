...
output_tensor = np.array([[[[0.3828125, 0.2890625, 0.15625, 0.08203125],
                            [0.27734375, 0.11328125, 0.26953125, 0.171875],
                            [0.25390625, 0.40234375, 0.49609375, 0.2421875],
                            [0.28125, 0.26953125, 0.3671875, 0.41796875]]]]).astype(np.float32)
...
def prepare_config():
    config_copy = copy.deepcopy(XINT8_CONFIG)
