...
fuse_layer_norm_golden_output = np.array([[0.13433924, 0.6985641, -0.7321489, -0.8127524, 0.23509368,
                                           0.43660256, 0.12090532, 0.900073, -0.11418836, -0.7321489]]).astype(np.float32)
...
def prepare_config(config):
    ...
    config_copy.extra_options['ConvertOpsetVersion'] = 20
...
def prepare_config_fuse_layer_norm(config):
    ...
    config_copy.extra_options['ConvertOpsetVersion'] = 17
    quant_config = Config(global_quant_config=config_copy)
    return quant_config
