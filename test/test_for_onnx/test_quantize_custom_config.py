...
QuantFormat_QOperator_with_CPU_golden_output = np.array([[[[0.24136764, 0.1602976, 0.02395251, -0.04790503],
...
QuantFormat_QOperator_with_NPU_golden_output = np.array([[[[0.25390625, 0.16015625, 0.0234375, -0.046875],
...
Int16Scale_golden_output = np.array([[[[0.24002075, 0.16062927, 0.02400208, -0.04800415],
                                       [0.14216614, -0.03692627, 0.1366272, 0.03692627],
                                       [0.123703, 0.26771545, 0.41357422, 0.11262512],
                                       [0.14955139, 0.13847351, 0.23448181, 0.28433228]]]]).astype(np.float32)

QuantFormat_QDQ_golden_output = np.array([[[[0.24002075, 0.16062927, 0.02400208, -0.04800415],
                                           [0.14216614, -0.03692627, 0.1366272, 0.03692627],
                                           [0.123703, 0.26771545, 0.41357422, 0.11262512],
                                           [0.14955139, 0.13847351, 0.23448181, 0.28433228]]]]).astype(np.float32)
