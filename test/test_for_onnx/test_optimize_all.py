...
input_data = np.array([[[[0.9296161, 0.31637555, 0.18391882, 0.20456028],
                        ...
                        [[0.9037225, 0.02467621, 0.49174732, 0.5262552],
                         ...
                         [0.21895005, 0.25871906, 0.46810576, 0.4593732]]]]).astype(np.float32)

split_large_kernel_pool_init_data = np.array([[[[0.9296161, 0.31637555, 0.18391882, 0.20456028, 0.567725],
                                               ...
                                               [[0.5314499, 0.16774222, 0.7688139, 0.92817056, 0.6094937],
                                                ...
                                                [0.8884217, 0.49541476, 0.35161653, 0.71423036, 0.50392914]]]]).astype(np.float32)

fuse_gelu_input_data = np.array([1.0], dtype=np.float32)

split_large_kernel_pool_with_input_shape_23x23_golden_output = np.array([[[[0.2578125]], [[0.2109375]], [[-0.1875]], [[-0.2890625]],
                                                                          [[-0.578125]], [[0.0078125]], [[-0.09375]], [[0.]],
                                                                          [[-0.2890625]], [[-0.1484375]], [[-0.3828125]], [[0.328125]],
                                                                          [[-0.515625]], [[-0.1328125]], [[-0.0546875]], [[-0.1640625]]]]).astype(np.float32)

split_large_kernel_pool_with_input_shape_25x25_golden_output = np.array([[[[0.28125]], [[0.2265625]], [[-0.1875]], [[-0.328125]],
                                                                          [[-0.625]], [[0.015625]], [[-0.09375]], [[-0.0078125]],
                                                                          [[-0.3046875]], [[-0.171875]], [[-0.421875]], [[0.34375]],
                                                                          [[-0.5859375]], [[-0.140625]], [[-0.046875]], [[-0.1953125]]]]).astype(np.float32)

fold_batch_norm_after_concat_golden_output = np.array([[-0.09765625, 0.28515625, 0.125, -0.2421875, -0.0078125, 0.109375, 0.14453125, -0.296875, 0.06640625, -0.0234375, -0.03125, 0.04296875, 0.03515625, -0.03125, 0.015625, 0.0703125]])

fold_batch_norm_golden_output = np.array([[0.08984375, 0.37109375, 0.03515625, -0.05078125, -0.01171875, 0.078125]]).astype(np.float32)

convert_split_to_slice_golden_output = np.array([[[[0.2890625, 0.6171875, 0.453125, 0.],
                                                  ...
                                                  [[0.0078125, 0.5703125, 0.125, -0.046875],
                                                   ...
                                                   [0.1328125, -0.0859375, -0.0234375, 0.0625]]]]).astype(np.float32)

convert_reduce_mean_to_global_avg_pool_golden_output = np.array([[[[0.5390625]], [[0.6328125]], [[0.4921875]]]]).astype(np.float32)

convert_bn_to_conv_golden_output = np.array([[[[-0.0078125, -0.0078125, 0.08203125, 0.08984375],
                                              ...
                                              [[-0.15234375, -0.26171875, -0.3984375, -0.3203125],
                                               ...
                                               [-0.23828125, -0.1796875, -0.37109375, -0.3671875]]]]).astype(np.float32)

convert_clip_to_relu_golden_output = np.array([[[[0.2890625, 0.6171875, 0.453125, 0.],
                                                 [0.625, 0.5859375, 0.6015625, 0.203125],
                                                 [0.4609375, 0.4453125, 0.53125, 0.5234375],
                                                 [0.296875, 0.375, 0.453125, 0.2265625]],
                                                [[0.0078125, 0.5703125, 0.125, 0.],
                                                 [0.3359375, 0.3984375, 0.2890625, 0.359375],
                                                 [0.1015625, 0.0703125, 0.3203125, 0.0703125],
...
class TransformerBlock(nn.Module):
    def __init__(self, emb_size, num_heads, mlp_dim, dropout=0.1):
        ...
        self.mlp = nn.Sequential(nn.Linear(emb_size, mlp_dim), nn.GELU(), nn.Linear(mlp_dim, emb_size),
                                 nn.Dropout(dropout))
...
def prepare_model(input_shape, model_type, output_dir: str):
    ...
    torch.onnx.export(model, dummy_input, onnx_model_path, input_names=['input'], output_names=['output'], keep_initializers_as_inputs=True, do_constant_folding=False, opset_version=opset_version)
...
class TestTensorQuantize(unittest.TestCase):
    ...
    def test_optimize_convert_reduce_mean_to_global_avg_pool(self, tmpdir: str):
        output, quantized_model_path = tensor_quantize(input_data, [1, 3, 4, 4], 'convert_reduce_mean_to_global_avg_pool', tmpdir)
