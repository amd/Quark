...
def prepare_config(config, is_replace_bfloat16_qdq_cast):
    ...
    if is_replace_bfloat16_qdq_cast:
        ...
        config_copy.extra_options["BF16QDQToCast"] = False
    return quant_config
...
def tensor_quantize(output_dir: str, input_data, is_replace_bfloat16_qdq_cast):
    ...
    quant_config = prepare_config(BF16_CONFIG, is_replace_bfloat16_qdq_cast)
