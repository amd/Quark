...
from quark.onnx.quantization.config.custom_config import A16W8_CONFIG, XINT8_CONFIG
...
golden_output = np.array(
    [
        [
            ...
            [[-0.09765625, -0.03125, -0.1171875], [-0.046875, 0.0, -0.07421875], [-0.0234375, 0.0, -0.02734375]],
            [
                [-0.09375, -0.1484375, -0.12890625],
                [-0.15234375, -0.21484375, -0.20703125],
                [-0.23828125, -0.265625, -0.21484375],
            ],
        ]
    ]
).astype(np.float32)
...
class TestTensorQuantize(unittest.TestCase):
    ...
    def test_quantize_xint8_config(self, tmpdir: str):
        ...
        self.assertTrue(
            any("Clip node " in message and "is converted to DPU version, min is" in message for message in cm.output)
        )
