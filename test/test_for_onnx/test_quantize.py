...
int8_input_tensor = np.array([[[[50, 55, -88, 9],
                                [100, 41, -78, -15],
                                [-40, -8, 90, -7],
                                [-88, -65, -81, -108]],
                               ...
                               [[-72, 0, -66, 44],
                                [-54, 44, -1, -6],
                                [-90, -113, -121, 81],
                                [118, 28, -27, -43]]]]).astype(np.int8)

uint8_input_tensor = np.array([[[[139, 251, 55, 193],
                                [100, 95, 138, 34],
                                [76, 44, 228, 168],
                                [152, 87, 31, 113]],
                                ...
                                [216, 195, 115, 91],
                                [170, 175, 150, 33],
                                [127, 71, 212, 244]]]]).astype(np.uint8)
...
def prepare_random_input_config_with_specific(input_dtype='float'):
    ...
    if input_dtype == 'float':
        ...
        config_copy.extra_options['RandomDataReaderInputDataRange'] = {'input': [-1e-1, 1e-1]}
        config_copy.extra_options['RandomDataReaderInputShape'] = {'input': [1, 3, 4, 4]}
    elif input_dtype == 'int8':
        config_copy.extra_options['UseRandomData'] = True
        config_copy.extra_options['RandomDataReaderInputDataRange'] = {'input': [-128, 127]}
        config_copy.extra_options['RandomDataReaderInputShape'] = {'input': [1, 3, 4, 4]}
    elif input_dtype == 'uint8':
        config_copy.extra_options['UseRandomData'] = True
        config_copy.extra_options['RandomDataReaderInputDataRange'] = {'input': [0, 255]}
        config_copy.extra_options['RandomDataReaderInputShape'] = {'input': [1, 3, 4, 4]}
    else:
        raise NotImplementedError(f'Unspecified input dtype {input_dtype}!')
...
def prepare_abnormal_random_input_config(abnormal_type='shape_key'):
    ...
    if abnormal_type == 'shape_key':
        config_copy.extra_options['UseRandomData'] = True
        config_copy.extra_options['RandomDataReaderInputDataRange'] = {'input': [-1e-1, 1e-1]}
        config_copy.extra_options['RandomDataReaderInputShape'] = {'inp': [1, 3, 4, 4]}
    elif abnormal_type == 'range_key':
        config_copy.extra_options['UseRandomData'] = True
        config_copy.extra_options['RandomDataReaderInputDataRange'] = {'inp': [-1e-1, 1e-1]}
        config_copy.extra_options['RandomDataReaderInputShape'] = {'input': [1, 3, 4, 4]}
    elif abnormal_type == 'dtype':
        config_copy.extra_options['UseRandomData'] = True
        config_copy.extra_options['RandomDataReaderInputDataRange'] = {'input': [-1e-1, 1e-1]}
        config_copy.extra_options['RandomDataReaderInputShape'] = [1, 3, 4, 4]
    else:
