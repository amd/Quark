...
@pytest.mark.parametrize("dtype,max_norm,torch_dtype", [
...
def test_fp8_per_tensor_quantize(dtype, max_norm, torch_dtype):
    ...
    process_fp8_per_tensor_quantize(DEFAULT_FP8_PER_TENSOR_SYM_SPEC, torch_device, scale, zero_point,
                                    torch_dtype, max_norm)


@pytest.mark.parametrize("quant_func,dequant_func,qdq_op,scale", [
