...
from quark.torch.quantization.config.type import Dtype, QSchemeType, ScaleType, RoundType, TQTThresholdInitMeth
...
def test_tqt_FakeQuantize():
    ...
    tqt_quantizer_weight = ScaledFakeQuantize(
        DEFAULT_QAT_INT8_PER_TENSOR_SPEC_TQT_WEIGHT)
    tqt_quantizer_input = ScaledFakeQuantize(
        DEFAULT_QAT_INT4_PER_TENSOR_SPEC_TQT_INPUT)
