...
def test_lsq_FakeQuantize():
    ...
    lsq_quantizer_weight = ScaledFakeQuantize(DEFAULT_QAT_INT8_PER_CHANNEL_SPEC_LSQ_WEIGHT, device=torch_device)
    lsq_quantizer_input = ScaledFakeQuantize(DEFAULT_QAT_INT8_PER_TENSOR_SPEC_LSQ_INPUT, device=torch_device)
