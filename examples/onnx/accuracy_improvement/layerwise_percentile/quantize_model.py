...
def main(args: argparse.Namespace) -> None:
    ...
    if args.calib_method == "minmax":
        ...
        activation_spec.set_calibration_method(CalibMethod.Percentile)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--calib_method", help="The PTQ algorithm selection for quantization", type=str, default="", required=False
    )
