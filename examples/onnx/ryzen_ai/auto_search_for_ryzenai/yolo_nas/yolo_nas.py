...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_model_path", help="Specify the input model to be quantized", default="yolo_nas_s.onnx", required=True
    )
    parser.add_argument("--data_dir", help="Specify the input model to be quantized", required=True)
    parser.add_argument("--calib_path", default="", help="Specify the input model to be quantized", required=False)
    parser.add_argument(
        "--calib_num", type=int, default=128, help="Specify the input model to be quantized", required=False
    )
