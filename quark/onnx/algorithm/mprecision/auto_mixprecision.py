...
from ..finetuning.onnx_evaluate import average_L2, inference_model
from ..finetuning.onnx_subgraph import Subgraph
from ..finetuning.torch_utils import optimize_module
from .mixing_fn import mixing_fn
...
def auto_mixprecision(
    f_model: str | Path | onnx.ModelProto,
    q_model: str | Path | onnx.ModelProto,
