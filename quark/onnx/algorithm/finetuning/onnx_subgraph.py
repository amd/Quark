...
class Subgraph:
    ...
    def get_f_input_output_data_single_pass(
        ...
        f_input_data: dict[int, NDArray[Any] | list[NDArray[Any]]] = {}
        f_output_data: dict[int, NDArray[Any] | list[NDArray[Any]]] = {}
    ...
    def get_f_input_output_data(
        self, index: int, data_size: int = -1
        ...
        # Get input data
        f_input_data: NDArray[Any] | list[Any] = []
        f_output_data: NDArray[Any] | list[Any] = []
    ...
    def get_q_input_data_in_parallel(self) -> dict[int, NDArray[Any] | list[NDArray[Any]]]:
        ...
        q_input_data: dict[int, NDArray[Any] | list[NDArray[Any]]] = {}
    ...
    def get_q_input_data(self, index: int) -> NDArray[Any] | list[Any]:
        aug_model = copy.deepcopy(self.qmodel)
        ...
        # Get input data
        q_input_data: NDArray[Any] | list[Any] = []
    ...
    def get_training_data(
        self, index: int
    ) -> tuple[NDArray[Any] | list[Any], NDArray[Any] | list[Any], NDArray[Any] | list[Any]]:
    ...
    def extract_submodel_weight(
        self,
    ) -> tuple[list[np.ndarray[Any, Any]], list[Any], list[np.ndarray[Any, Any] | None], list[Any]]:
        f_weight = []
        f_bias: list[NDArray[Any] | None] = []
        q_weight_name = []
        q_bias_name = []
