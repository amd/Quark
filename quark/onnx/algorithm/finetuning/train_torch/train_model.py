...
class ModelOptimizer:
    ...
    def run(
        self,
        quant_module: torch.nn.Module,
        inp_data_quant: numpy.ndarray[Any, Any] | list[numpy.ndarray[Any, Any]],
        inp_data_float: numpy.ndarray[Any, Any] | list[numpy.ndarray[Any, Any]],
        out_data_float: numpy.ndarray[Any, Any] | list[numpy.ndarray[Any, Any]],
        params: TrainParameters,
    ) -> None:
        """
    ...
    def run_with_dataset(
        ...
        if params.lr_adjust is not None:
