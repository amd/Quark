...
def create_fn_quantizer(quant_info: dict[str, Any]) -> BFPQuantizer | MXQuantizer:
...
class QuantizationModule(torch.nn.Module):  # type: ignore
    ...
    def __init__(
        ...
        self.quantizer: INTQuantizer | FPQuantizer | BFPQuantizer | MXQuantizer | None = None
...
class QuantizeWrapper(torch.nn.Module, ABC):  # type: ignore
    ...
    def __init__(self, w_alpha: float = 1.0, b_beta: float = 1.0, **kwargs: dict[str, Any]) -> None:
        ...
        self.input_quantizer: INTQuantizer | FPQuantizer | BFPQuantizer | MXQuantizer | None = None
        self.weight_quantizer: INTQuantizer | FPQuantizer | BFPQuantizer | MXQuantizer | None = None
        self.bias_quantizer: INTQuantizer | FPQuantizer | BFPQuantizer | MXQuantizer | None = None
