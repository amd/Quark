...
class ONNXModelParser:
    ...
    def _find_node_input_init(self, node: NodeProto, index: int) -> TensorProto | None:
    ...
    @log_errors
    def _find_node_input_qdq(self, node: NodeProto, index: int) -> tuple[NodeProto | None, NodeProto | None]:
    ...
    @log_errors
    def _find_node_input_fn(self, node: NodeProto, index: int) -> NodeProto | None:
    ...
    def _parse_qdq_quant_info(
        self, dq: NodeProto | None, q: NodeProto | None
    ) -> tuple[NDArray[np.float32], NDArray[Any], NDArray[Any], NDArray[Any], int, bool, Any] | None:
    ...
    def _parse_fn_quant_info(self, fn: NodeProto) -> dict[str, Any] | None:
    ...
    @log_errors
    def _find_node_output_qdq(self, node: NodeProto, index: int) -> tuple[NodeProto | None, NodeProto | None]:
    ...
    def _find_node_output_fn(self, node: NodeProto, index: int) -> NodeProto | None:
    ...
    def get_output_node(self, node: NodeProto) -> NodeProto | None:
