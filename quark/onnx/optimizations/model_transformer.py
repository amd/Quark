...
class ModelTransformer:
    ...
    def _get_consuming_nodes(self, check_node: NodeProto | TensorProto | ValueInfoProto) -> dict[int, list[str]]:
    ...
    def _get_output_consumers(self, check_node: NodeProto | TensorProto | ValueInfoProto) -> dict[int, ValueInfoProto]:
    ...
    @staticmethod
    def _get_node_name(node: NodeProto | TensorProto | ValueInfoProto) -> str:
        return node.name

    @staticmethod
    def _node_type(node: NodeProto | TensorProto | ValueInfoProto | None) -> NodeType:
    ...
    def _get_matched_nodes(self, transform: Transform) -> list[str]:
    ...
    def _match_node_with_inputs(
        self, node: NodeProto, pattern: OpTypePattern, is_head_node: bool, allow_multi_consumers: bool
    ) -> NodeTree | None:
    ...
    @staticmethod
    def _add_node_init(model: ModelProto, node_init_to_add: NodeProto | TensorProto | ValueInfoProto | None) -> None:
    ...
    def _get_leaf_nodes(self, node_tree: NodeTree) -> list[NodeProto | TensorProto | ValueInfoProto | None]:
    ...
    @staticmethod
    def _get_input_index(node: NodeProto, input_tensor: TensorProto | ValueInfoProto) -> int:
